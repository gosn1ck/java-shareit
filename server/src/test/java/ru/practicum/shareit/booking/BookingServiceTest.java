...
class BookingServiceTest {
    ...
    void shouldANotAddBooking() {
        ...
        assertEquals(String.format("impossible to book item with %d ", item.getId()), exceptionNotFound.getMessage());
        ...
        assertEquals(String.format("item with id %d is not available", item.getId()), exceptionBadRequest.getMessage());
